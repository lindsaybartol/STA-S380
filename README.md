...
<br>I decided on this question because I believe it gives an overall interpretation of what the news has been focusing on during the time these articles were written. This can show a lot about what the American media values and what an American audience is interested in hearing.  
### Approach
In my analysis, I started by preprocessing the data, then I used a Literary Model to analyze and group the topics. 
